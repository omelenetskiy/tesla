...
> Update 2026-09-14: актуальный статус и шаги продолжения перенесены в
> `.logs/2026-09-14-RESUME-WHEN-DNS-READY.md`.
> Используйте этот файл как главный источник для возобновления после DNS validation.
