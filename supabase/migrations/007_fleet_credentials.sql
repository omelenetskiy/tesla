...
-- vehicle_id because the Fleet API worked per vehicle; keeping both keyed the same way
-- would let a stale per-vehicle Fleet API row silently win over a live Fleet token, which
